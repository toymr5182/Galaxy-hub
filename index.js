...
function createManagedBot({ username, accountType, theme, autoLogin, loginPassword, autoCommands, chestPos, autoServerSelect, serverSelectItem }) {
  const state = {
    id: nextBotId++,
    username,
...
app.post('/bot/:id/settings', (req, res) => {
  ...
  const { autoLogin, loginPassword, autoCommands, autoServerSelect, serverSelectItem } = req.body
  ...
  <script>
    ...
    function saveSettings() {
      ...
      fetch('/bot/' + STATE.id + '/settings', {
        ...
        body: JSON.stringify({autoLogin:STATE.autoLoginOn,loginPassword:password,autoCommands:STATE.autoCommands,autoServerSelect:STATE.autoServerSelectOn,serverSelectItem:serverSelectItem})
      }).then(function(){
